...
ggsave("../figure_R/cop_otp_head_grooming_LED.png", gp1, width = 3, height = 5.5, dpi = 300)
ggsave("../figure_R/cop_opt_head_grooming_laser.png", gp2, width = 3, height = 5.5, dpi = 300)